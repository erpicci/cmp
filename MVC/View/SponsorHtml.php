 ...
 * @author Marco Zanella <mz@openmailbox.org>
 */
class SponsorHtml implements \ObserverInterface
{
    /**
    ...
    {
        echo "<article><h2>" . $this->sponsor->name
           . "[" . $this->sponsor->id . "]</h2>"
           . "<a href='" . $this->sponsor->website . "'>"
           . $this->sponsor->website . "</a></article>";
